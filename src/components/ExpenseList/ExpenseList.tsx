...
const ExpenseList: React.FC<any> = (props: ExpenseListProps) => {
  ...
  return <div className="h-full w-full">
    {expenses && expenses.length === 0 && <div className="h-20 dark:text-white w-full flex items-center justify-center text-xl text-gray-700">You have not recorded any expenses yet.</div>} 
